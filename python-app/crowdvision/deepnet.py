...
def fuse(ensemble_count: float, deep: DeepResult, crowdness: float = 1.0) -> int:
    """
    ...
    """
    trust = max(0.0, min(1.0, (crowdness - 0.45) / 0.15))
    w = 0.78 * (deep.agreement ** 1.5) * trust * (0.7 + 0.3 * deep.focus)
